        ...
        <div id="main">            
            ...
            <form action="updateCost.do" method="post" class="main_form">
                ...
                <div class="input_info fee_type">
                    <input type="radio" name="cost-type" value="1" <c:if test="${cost.cost_type==1}">checked</c:if> id="monthly" onclick="feeTypeChange(1);" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="cost-type" value="2" <c:if test="${cost.cost_type==2}">checked</c:if> id="package" onclick="feeTypeChange(2);" />
                    <label for="package">套餐</label>
                    <input type="radio" name="cost-type"  value="3"<c:if test="${cost.cost_type==3}">checked</c:if> id="timeBased" onclick="feeTypeChange(3);" />
