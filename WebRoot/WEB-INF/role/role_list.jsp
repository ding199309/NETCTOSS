    ...
    <body>
        ...
        <div id="main">
            <form action="" method="">
                ...
                <div id="data">                      
                    <table id="datalist">
                        ...
                        <tr>                      
                            ...
                            <td>${r.name}</td>
                            <td>
                            <c:forEach items="${r.modules}" var="c" varStatus="i">
                            		<c:choose>
                            			<c:when test="${i.last}">
                            				${c.name}
                            			</c:when>
                ...
                <!--分页-->
                <div id="pages">
                <c:if test="${rolePage.currentPage==1}">
        	     ...
        	     <c:if test="${rolePage.currentPage!=1}">
        	        <a href="findRole.do?currentPage=${rolePage.currentPage-1}">上一页</a>
  					...
  					<c:if test="${i==rolePage.currentPage}">
                 ...
                 <c:if test="${rolePage.currentPage==rolePage.totalPage}">
